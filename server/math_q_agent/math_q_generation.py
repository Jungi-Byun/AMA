...
def generate_question(state: State):
    ...
    try:
        ...
        if key in ADDITIONAL_INFO:
            ...
            print(f"[generate_question] add_info: {add_info}")
        else: 
            add_info = ""
        
        messages = get_prompt(state["sample_question"], state["topic"], add_info)
        print(f"[generate_question] messages: {messages}")
        ...
        print(f"[generate_question] State: {question_list}")
        state["question_list"] = question_list
        return {"question_list": state["question_list"]}
    except Exception as e:
        print(f"[generate_question] Internal server error")
